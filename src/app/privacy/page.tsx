...
import PinWidget from '@/components/widgets/PinWidget'
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4">
      <div className="col-span-1 lg:col-span-2 xl:col-span-3">
        <Canvas className="px-0 sm:px-8 text-left text-xs text-gray-500">
      ...
      <div className="hidden lg:flex lg:col-span-1 lg:flex-col lg:gap-4">
        <PinWidget />
        <AboutWidget />
        <CategoryWidget />
        <TagWidget />
