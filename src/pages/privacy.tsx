    ...
    <>
      <main>
        <Stack spacing={2}>
          ...
          <Paper>
            <Box px={{ xs: 1, sm: 4, md: 8 }} py={2}>
              <Stack spacing={4}>
                <Typography>
                  53ningen.com（以下、「当サイト」と言います。）では、お客様からお預かりする個人情報の重要性を強く認識しており、個人情報の保護に関する法律、その他の関係法令を遵守すると共に、以下に定めるプライバシーポリシーに従って、個人情報を安全かつ適切に取り扱うことを宣言します。
                </Typography>
                <Typography variant="h3">1. 個人情報の定義</Typography>
                <Typography>
                  本プライバシーポリシーにおいて、個人情報とは生存する個人に関する情報であり、氏名、生年月日、住所、電話番号、メールアドレスなど、特定の個人を識別することができるものをいいます。
                </Typography>
                <Typography variant="h3">2. 個人情報の管理</Typography>
                <Typography>
                  お客様からお預かりした個人情報は、不正アクセス、紛失、漏えいなどが起こらないよう、慎重かつ適切に管理します。
                </Typography>
                <Typography variant="h3">3. 個人情報の利用目的</Typography>
                <Typography>
                ...
                <Typography variant="h3">4. 個人情報の第三者提供</Typography>
                <Typography>
                ...
                <Typography variant="h3">6. アクセス解析ツールについて</Typography>
                <Typography>
                ...
                <Typography variant="h3">7. Cookie（クッキー）について</Typography>
                <Typography>
                ...
                <Typography variant="h3">8. 広告の配信について</Typography>
                <Stack spacing={2}>
                  <Typography>
                    当サイトでは、第三者配信の広告サービスを利用しています。
                    広告配信事業者は、お客様の過去のアクセス情報に基づいて、適切な広告を配信する場合があります。
                  </Typography>
                  <Typography variant="h4">Amazonアソシエイトについて</Typography>
                  <Typography>
                    当サイトは、Amazon.co.jpを宣伝しリンクすることによってサイトが紹介料を獲得できる手段を提供することを目的に設定されたアフィリエイトプログラムである、Amazonアソシエイト・プログラムの参加者です。
                  </Typography>
                </Stack>
                <Typography variant="h3">9. 免責事項</Typography>
                <Typography>
                ...
                <Typography variant="h3">10. 本ポリシーの変更について</Typography>
                <Typography>
            ...
            <Box textAlign="right">
              <Typography variant="caption">
                参考:{' '}
                <Link href="https://takapon.net/howto-make-privacy-policy/">takalog</Link>
              </Typography>
            </Box>
          </Paper>
        </Stack>
